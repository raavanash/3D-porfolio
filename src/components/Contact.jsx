...
const Contact = () => {
  ...
  // TODO: sign up at emailjs.com (free) and replace these three values
  // with your own Service ID, Template ID, and Public Key — the ones
  // below belong to the original template author and won't deliver mail to you.
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs
      .sendForm(
        ...
        {!loaded && (
          ...
          >
            <div className="text-cyan-400 font-mono text-[10px] uppercase tracking-[0.5em] mb-4 animate-pulse">
              Loading Contact Section {loadingProgress}%
            </div>
        ...
        {loaded && (
          ...
          >
            ...
            <div className="absolute top-12 left-12 flex items-center space-x-3">
               ...
               <span className="text-cyan-400/40 text-[9px] tracking-[0.4em] uppercase font-bold">Available for work</span>
            </div>
            
            <div className="absolute bottom-12 right-12 text-right hidden lg:block">
               <span className="text-white/10 text-[9px] tracking-[0.6em] uppercase block mb-1">Response time: ~24h</span>
               <span className="text-cyan-500/30 text-[9px] tracking-[0.4em] uppercase">&gt; Ready to connect</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
          ...
          >
            <div className="text-center mb-8">
              ...
              <div className="flex items-center justify-center space-x-2 text-cyan-500/60 font-mono text-[9px] tracking-[0.6em] uppercase">
                <FiShield />
                <span>Your message goes straight to my inbox</span>
              </div>
            </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">Your Name</label>
                  <input
                    name="name"
                    type="text"
                ...
                <div className="space-y-3">
                  <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">Your Email</label>
                  <input
                    name="email"
                    type="email"
              ...
              <div className="space-y-3">
                <label className="text-[9px] font-mono font-bold uppercase tracking-[0.3em] text-cyan-500/50 block ml-1">Your Message</label>
                <textarea
                  name="message"
