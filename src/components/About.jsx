...
export default function About() {
  const Aboutdata = [
    {
      icon: <FiCode size={20} />,
      title: "Languages",
      desc: "JavaScript, TypeScript, Python, React, Node.js, MongoDB",
    },
    {
      icon: <FiBookOpen size={20} />,
      title: "Education",
      desc: "B.Tech Computer Science, Reva University",
    },
    {
      icon: <FiAward size={20} />,
      title: "Projects",
      desc: "Built 5+ full-stack & AI-powered projects",
    },
  ];
  ...
  const Tools = [
    ...
    { icon: <SiTensorflow size={24} />, title: "TensorFlow / AI" },
            ...
            <div className="w-full lg:w-[65%] flex flex-col space-y-10 pointer-events-auto bg-black/40 backdrop-blur-sm p-8 md:p-12 border border-white/5 rounded-2xl">
                ...
                <div className="robotic-section">
                    <p className="text-gray-400 text-sm md:text-md lg:text-xl font-light leading-relaxed max-w-2xl">
                        I'm a Computer Science graduate and <span className="text-white font-medium">AWS Certified Developer</span> working 
                        across the MERN stack, with hands-on experience building scalable web applications 
                        and supporting technology operations. My work spans high-traffic platforms serving 
                        10,000+ monthly users to precision machine learning models for healthcare. I bring 
                        clean code and creative problem-solving together — whether optimizing database 
                        performance or performing at open mics.
                    </p>
                </div>
