            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="flex gap-4 mb-8">
                <div className="h-10 px-3 bg-white flex items-center justify-center rounded-sm">
                   <span className="text-black font-black text-[10px] tracking-tighter">RADIENT TECH</span>
                </div>
                <div className="h-10 px-3 border border-white/20 flex items-center justify-center rounded-sm">
                   <span className="text-white font-bold text-[10px] tracking-widest">CONTRACT</span>
                </div>
              </div>

              <p className="text-gray-400 font-light text-sm leading-relaxed mb-12">
                Worked as a <span className="text-white font-medium">Web Developer (Contract)</span> at Radient Technology, Bengaluru, 
                building dynamic front-end features with React and Tailwind CSS, improving load times by 30% 
                and delivering reusable components alongside the design team.
              </p>
